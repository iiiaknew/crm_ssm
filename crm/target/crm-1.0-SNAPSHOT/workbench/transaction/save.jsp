...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;" id="tranForm" action="workbench/tran/save.do">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" id="create-activityId" value="2aa447b8ce3d430d873c35b573d90aa5" name="activityId">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" id="create-contactsId" value="4085828dc08347d7b773d650b7846891" name="contactsId"/>
        </div>
    </div>
